# manager.datasets.demo_data { #spotforecast2_safe.manager.datasets.demo_data }
...
| Name | Description |
| --- | --- |
| [DemoConfig](#spotforecast2_safe.manager.datasets.demo_data.DemoConfig) | Configuration for the safety-critical demo task. |

### DemoConfig { #spotforecast2_safe.manager.datasets.demo_data.DemoConfig }
