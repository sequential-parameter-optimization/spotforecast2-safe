...
| Name | Description |
| --- | --- |
| [fetch_archive](#spotforecast2_safe.weather.client.WeatherService.fetch_archive) | Fetch historical data from Archive API. |
| [fetch_forecast](#spotforecast2_safe.weather.client.WeatherService.fetch_forecast) | Fetch forecast data from Forecast API. |
...
### fetch_archive { #spotforecast2_safe.weather.client.WeatherService.fetch_archive }

```python
weather.client.WeatherService.fetch_archive(start, end, timezone='UTC')
```
...
### fetch_forecast { #spotforecast2_safe.weather.client.WeatherService.fetch_forecast }

```python
weather.client.WeatherService.fetch_forecast(
    days_ahead,
    timezone='UTC',
    past_days=0,
)
