# submission_cli { #spotforecast2_safe.submission_cli }
...
| Name | Description |
| --- | --- |
| [AbortReason](#spotforecast2_safe.submission_cli.AbortReason) | Named failure categories for :class:`SubmissionAbort`. |
| [SubmissionAbort](#spotforecast2_safe.submission_cli.SubmissionAbort) | Raised by the five gate helpers when a submission cannot proceed. |

### AbortReason { #spotforecast2_safe.submission_cli.AbortReason }
...
### SubmissionAbort { #spotforecast2_safe.submission_cli.SubmissionAbort }
...
| Name | Description |
| --- | --- |
| [assert_coverage_or_abort](#spotforecast2_safe.submission_cli.assert_coverage_or_abort) | Assert data-quality coverage, aborting on guard violations. |
| [compute_dates_or_abort](#spotforecast2_safe.submission_cli.compute_dates_or_abort) | Compute the submission date window, aborting on invalid inputs. |
| [download_combined_or_abort](#spotforecast2_safe.submission_cli.download_combined_or_abort) | Download the combined DE-total series with snapshot fallback, or abort. |
| [entsoe_predictions](#spotforecast2_safe.submission_cli.entsoe_predictions) | Return the ENTSO-E day-ahead hourly forecast series (tolerant). |
| [load_interim_or_abort](#spotforecast2_safe.submission_cli.load_interim_or_abort) | Read the combined DE-total interim CSV, aborting if it is missing. |

### assert_coverage_or_abort { #spotforecast2_safe.submission_cli.assert_coverage_or_abort }
...
### compute_dates_or_abort { #spotforecast2_safe.submission_cli.compute_dates_or_abort }
...
### download_combined_or_abort { #spotforecast2_safe.submission_cli.download_combined_or_abort }
...
### entsoe_predictions { #spotforecast2_safe.submission_cli.entsoe_predictions }
...
### load_interim_or_abort { #spotforecast2_safe.submission_cli.load_interim_or_abort }
