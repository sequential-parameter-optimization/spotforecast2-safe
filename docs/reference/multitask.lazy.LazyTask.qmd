...
| Name | Description |
| --- | --- |
| [agg_predictor](#spotforecast2_safe.multitask.lazy.LazyTask.agg_predictor) | Aggregate per-target prediction packages into a weighted forecast. |
| [build_exogenous_features](#spotforecast2_safe.multitask.lazy.LazyTask.build_exogenous_features) | Build, combine, encode, and merge exogenous feature covariates. |
| [create_forecaster](#spotforecast2_safe.multitask.lazy.LazyTask.create_forecaster) | Create a fresh forecaster for the given target. |
| [cv_ts](#spotforecast2_safe.multitask.lazy.LazyTask.cv_ts) | Build a ``TimeSeriesFold`` for cross-validation. |
| [detect_outliers](#spotforecast2_safe.multitask.lazy.LazyTask.detect_outliers) | Apply hard-bound filtering and IsolationForest outlier detection. |
| [impute](#spotforecast2_safe.multitask.lazy.LazyTask.impute) | Fill missing values using the configured imputation strategy. |
| [load_models](#spotforecast2_safe.multitask.lazy.LazyTask.load_models) | Load the most recent fitted models from the cache directory. |
| [load_tuning_results](#spotforecast2_safe.multitask.lazy.LazyTask.load_tuning_results) | Load the most recent tuning results for a target from cache. |
| [log_summary](#spotforecast2_safe.multitask.lazy.LazyTask.log_summary) | Log a summary of the current pipeline configuration. |
| [plot_with_outliers](#spotforecast2_safe.multitask.lazy.LazyTask.plot_with_outliers) | Visualise original vs. cleaned data with outlier markers. |
| [prepare_data](#spotforecast2_safe.multitask.lazy.LazyTask.prepare_data) | Load, resample, validate, and configure the pipeline data. |
| [run](#spotforecast2_safe.multitask.lazy.LazyTask.run) | Run lazy fitting for all targets. |
| [save_models](#spotforecast2_safe.multitask.lazy.LazyTask.save_models) | Save fitted forecaster models to the cache directory. |
| [save_tuning_results](#spotforecast2_safe.multitask.lazy.LazyTask.save_tuning_results) | Save tuning results (best parameters and lags) to a JSON file. |

### agg_predictor { #spotforecast2_safe.multitask.lazy.LazyTask.agg_predictor }

```python
multitask.lazy.LazyTask.agg_predictor(results, targets, weights)
```
...
### build_exogenous_features { #spotforecast2_safe.multitask.lazy.LazyTask.build_exogenous_features }

```python
multitask.lazy.LazyTask.build_exogenous_features()
```
...
### create_forecaster { #spotforecast2_safe.multitask.lazy.LazyTask.create_forecaster }

```python
multitask.lazy.LazyTask.create_forecaster(target=None)
```
...
### cv_ts { #spotforecast2_safe.multitask.lazy.LazyTask.cv_ts }

```python
multitask.lazy.LazyTask.cv_ts(y_train)
```
...
### detect_outliers { #spotforecast2_safe.multitask.lazy.LazyTask.detect_outliers }

```python
multitask.lazy.LazyTask.detect_outliers()
```
...
### impute { #spotforecast2_safe.multitask.lazy.LazyTask.impute }

```python
multitask.lazy.LazyTask.impute()
```
...
### load_models { #spotforecast2_safe.multitask.lazy.LazyTask.load_models }

```python
multitask.lazy.LazyTask.load_models(
    task_name=None,
    target=None,
    max_age_days=None,
)
...
### load_tuning_results { #spotforecast2_safe.multitask.lazy.LazyTask.load_tuning_results }

```python
multitask.lazy.LazyTask.load_tuning_results(
    target,
    task_name=None,
    max_age_days=None,
)
...
### log_summary { #spotforecast2_safe.multitask.lazy.LazyTask.log_summary }

```python
multitask.lazy.LazyTask.log_summary()
```
...
### plot_with_outliers { #spotforecast2_safe.multitask.lazy.LazyTask.plot_with_outliers }

```python
multitask.lazy.LazyTask.plot_with_outliers()
```
...
### prepare_data { #spotforecast2_safe.multitask.lazy.LazyTask.prepare_data }

```python
multitask.lazy.LazyTask.prepare_data(demo_data=None, df_test=None)
```
...
### save_models { #spotforecast2_safe.multitask.lazy.LazyTask.save_models }

```python
multitask.lazy.LazyTask.save_models(task_name, forecasters=None)
```
...
### save_tuning_results { #spotforecast2_safe.multitask.lazy.LazyTask.save_tuning_results }

```python
multitask.lazy.LazyTask.save_tuning_results(
    target,
    task_name,
    best_params,
    best_lags,
