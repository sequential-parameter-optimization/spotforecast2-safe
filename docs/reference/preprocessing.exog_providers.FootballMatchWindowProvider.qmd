...
| column          | [Optional](`typing.Optional`)\[[str](`str`)\]                                                    | Output column name. Defaults to ``"football_match_window"``.                                                | `None`    |
...
| Name | Description |
| --- | --- |
| [build](#spotforecast2_safe.preprocessing.exog_providers.FootballMatchWindowProvider.build) | Return a single-column ``float32`` frame with event-window values. |
